...
},{"./modules/modals/init-modals":2,"./modules/play-video":4,"./utils/ios-vh-fix":7}],2:[function(require,module,exports){
"use strict";
...
var mainHeaderElement = document.querySelector('[data-main-header]');
function playVideo() {
  if (videos) {
